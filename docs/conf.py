...
version = batchglm.__version__.replace('.dirty', '')
release = version
...
html_context = dict(
    ...
    github_repo='batchglm',  # Repo name
...
latex_documents = [
    (master_doc, 'batchglm.tex', 'batchglm Documentation',
...
man_pages = [
    (master_doc, 'batchglm', 'batchglm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'batchglm', 'batchglm Documentation',
     author, 'batchglm', 'One line description of project.',
     'Miscellaneous'),
]
...
github_url2 = 'https://github.com/theislab/batchglm/tree/master'
