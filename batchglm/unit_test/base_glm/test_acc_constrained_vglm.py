...
class _Test_AccuracyConstrained_VGLM_Estim():
...
class Test_AccuracyConstrained_VGLM(unittest.TestCase, metaclass=abc.ABCMeta):
    """
    Test whether optimizers yield exact results if constraints are used.
    ...
    """
    _estims: List[_Test_AccuracyConstrained_VGLM_Estim]
