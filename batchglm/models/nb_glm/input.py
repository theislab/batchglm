...
from .external import BasicInputData, parse_design
...
INPUT_DATA_PARAMS = {
    ...
    "constraints_loc": ("constraints_loc_model", "design_loc_params"),
    "constraints_scale": ("constraints_scale_model", "design_scale_params"),
