...
from . import AbstractNegativeBinomialEstimator, TFEstimator, TFEstimatorGraph, fit

__all__ = ['NegativeBinomialEstimatorGraph', 'TF_NegativeBinomialEstimator']


class NegativeBinomialEstimatorGraph(TFEstimatorGraph):
...
class TF_NegativeBinomialEstimator(AbstractNegativeBinomialEstimator, TFEstimator):
    model: NegativeBinomialEstimatorGraph
    
    def __init__(self, input_data: dict, tf_estimator_graph=None):
        if tf_estimator_graph is None:
            tf_estimator_graph = NegativeBinomialEstimatorGraph()
